...
var file_pkg_plugin_plugin_proto_msgTypes = make([]protoimpl.MessageInfo, 18)
var file_pkg_plugin_plugin_proto_goTypes = []any{
	...
	nil,                                // 15: plugin.ExecuteRequest.EnvEntry
	nil,                                // 16: plugin.ValidateConfigRequest.ConfigEntry
	nil,                                // 17: plugin.GetSchemaResponse.PropertiesEntry
}
var file_pkg_plugin_plugin_proto_depIdxs = []int32{
	...
	15, // 3: plugin.ExecuteRequest.env:type_name -> plugin.ExecuteRequest.EnvEntry
	13, // 4: plugin.ExecuteResponse.finalizers:type_name -> plugin.FinalizerRequest
	16, // 5: plugin.ValidateConfigRequest.config:type_name -> plugin.ValidateConfigRequest.ConfigEntry
	17, // 6: plugin.GetSchemaResponse.properties:type_name -> plugin.GetSchemaResponse.PropertiesEntry
	10, // 7: plugin.GetSchemaResponse.PropertiesEntry.value:type_name -> plugin.SchemaProperty
	0,  // 8: plugin.DSPlugin.GetManifest:input_type -> plugin.GetManifestRequest
	4,  // 9: plugin.DSPlugin.Execute:input_type -> plugin.ExecuteRequest
	6,  // 10: plugin.DSPlugin.ValidateConfig:input_type -> plugin.ValidateConfigRequest
	8,  // 11: plugin.DSPlugin.GetSchema:input_type -> plugin.GetSchemaRequest
	11, // 12: plugin.HostConfig.GetEffectiveConfig:input_type -> plugin.GetEffectiveConfigRequest
	1,  // 13: plugin.DSPlugin.GetManifest:output_type -> plugin.GetManifestResponse
	5,  // 14: plugin.DSPlugin.Execute:output_type -> plugin.ExecuteResponse
	7,  // 15: plugin.DSPlugin.ValidateConfig:output_type -> plugin.ValidateConfigResponse
	9,  // 16: plugin.DSPlugin.GetSchema:output_type -> plugin.GetSchemaResponse
	12, // 17: plugin.HostConfig.GetEffectiveConfig:output_type -> plugin.GetEffectiveConfigResponse
